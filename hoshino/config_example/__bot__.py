...
SUPERUSERS = [QQQQQQ]    # 填写超级用户的QQ号，可填多个用半角逗号","隔开
PYS ={}            #高级权限用户的QQ号



NICKNAME = r'藻藻|玉藻|at,qq=123456789'           # 设置bot的昵称，at，qq=xxxxxxxx处为bot的QQ号,呼叫昵称等同@bot
