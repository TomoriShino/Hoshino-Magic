...
headers = {
    token: 'eyJhbGciOiJIUzI1NiJ9..LP7mvsQvruxR3UCXXD2n_HRhMPUXNxayQsTQmz2WkVo'
...
async def query_ranking(date: str, page: int) -> dict:
    ...
    url = 'https://api.acg-gov.com/public/ranking?ranking_type=illust&mode={MODE}&date={date}&per_page={PER_PAGE}&page={page+1}'
    data = {}
    try:
